...
function injectNav(activePage) {
  document.body.insertAdjacentHTML('beforeend', `
    ...
    <div id="drawer" style="position:fixed;top:0;left:max(0px, calc(50% - 240px));height:100%;width:280px;max-width:80vw;background:var(--bg-card);z-index:301;transform:translateX(-100%);transition:transform 0.28s ease;overflow-y:auto;display:flex;flex-direction:column;">
